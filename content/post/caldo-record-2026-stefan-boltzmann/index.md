...
Questo vale anche al contrario, ed è il punto cruciale per il clima: la Terra si mantiene in equilibrio termico quando l'energia solare assorbita è pari all'energia che il pianeta re-irradia verso lo spazio, secondo esattamente questa legge — un bilancio che si scrive così:

$$\frac{S}{4}(1-\alpha) = \sigma T^4 \tag{EB}$$

dove $S \approx 1361 \; \text{W/m}^2$ è la costante solare, l'energia che il Sole invia a ogni metro quadrato all'altezza dell'orbita terrestre; il fattore $4$ tiene conto che la Terra intercetta la luce solare come un disco ma la re-irradia in ogni direzione come una sfera; $\alpha \approx 0{,}3$ è l'albedo terrestre, la frazione di luce riflessa senza essere assorbita. Risolvendo l'equazione per $T$ si ottiene una temperatura di equilibrio di circa $255\,\text{K}$, cioè $-18\,°\text{C}$: un pianeta gelido, ben più freddo dei circa $15\,°\text{C}$ medi che misuriamo davvero. Quei $33\,°\text{C}$ di differenza sono l'effetto serra — l'atmosfera trattiene parte della radiazione infrarossa che la Terra dovrebbe re-irradiare secondo l'equazione (EB), spostando l'equilibrio verso una $T$ più alta.

Se qualcosa — come l'aumento dei gas serra in atmosfera — riduce anche di poco l'efficienza con cui il pianeta riesce a re-irradiare calore, il sistema non si riequilibra con un piccolo aggiustamento lineare. Serve una variazione di temperatura sproporzionatamente più significativa perché l'equazione torni a bilanciarsi, perché è $T^4$ a dover compensare, non $T$.
