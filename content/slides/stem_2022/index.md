...
<ul class="fragment" data-transition="concave">
  <li><h3>Contenuti - Lezione frontale</h3></li>
    <ul>
      ...
      <li>strumenti</li>
      <ul>
        <li>libro di testo; <a style="color:#8A4117" href="https://2023-mathofthings.netlify.app/" target="_blank"><em>website</em></a>; <a style="color:#8A4117" href="https://2023-mathofthings.netlify.app/slides/stem_2022/" target="_blank"><em>slides</em></a></li>
      </ul>
    </ul>
</section>
...
<section data-background-image="calm_bkg.jpg" data-background-opacity="0.4" data-transition="convex">
<h1 style="color:#8A4117">FASE 5</h2>
<h2 style="color:#3B2F2F" class="r-fit-text">RIASSUNTIVA - RECAP </h2>
