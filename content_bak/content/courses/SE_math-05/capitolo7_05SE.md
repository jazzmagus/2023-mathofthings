...
linktitle: Capitolo 7 | Frazioni algebriche SE
toc: true
type: docs
...
- **Fattorizzazione polinomiale**
  ...
  - indispensabile per poter semplificare una _frazione algebrica_

- **mcm** tra polinomi

  - per potersi riportare alla **forma normale** di una _frazione algebrica_: $\frac{N(x)}{D(x)}$
...
- Il _dividendo_ prende il nome di <font color="brown">**numeratore**</font>
- Il _divisore_ prende il nome di <font color="brown">**denominatore**</font>
...
1. Ridurla in **forma normale**, nel caso si trattasse di un'_espressione con frazioni algebriche_
...
3. il denominatore comune cercato (_minimo comune denominatore_) è il **mcm** dei denominatori;
...
#### $\Rightarrow$ serve a calcolare il _minimo comun denominatore_
...
2. **secondo principio**: moltiplicando o dividendo entrambi i membri di una uguaglianza per uno **stesso numero** _diverso da zero_, o per una **stessa espressione** che non possa annullarsi, si ottiene un'equazione **equivalente** a quella data.
